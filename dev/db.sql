...
VALUES
  ...
  (1, 3, 'spotify:4PTG3Z6ehGkBFwjybzWkR8', '<b>[phase 1]</b> Never Gonna Give You Up (<b>Spotify</b>) <u>requires premium subscription or browser extension w/ background tab</u>'),
  (1, 4, 'dropbox:audio:r1gdw6cssgdyb07nmv5i9/Chung-Antique-Sweater-Weather-01-Former-Farmer.mp3?rlkey=ifflu911fuh56rx3rp6xdc88m',
            '<b>[phase 1]</b> Chung Antique - Former Farmer (<b>Dropbox</b> share link)'),
  (1, 5, 'link:audio:https://files.ceenaija.com/wp-content/uploads/music/2023/07/Rick_Astley_-_Never_Gonna_Give_You_Up_CeeNaija.com_.mp3',
            '<b>[phase 1]</b> Never Gonna Give You Up - Live (<b>generic internet link</b>)'),
  (1, 6, 'deezer:781592622', '[phase 2] Never Gonna Give You Up (<b>Deezer</b>) <u>requires premium subscription and browser extension</u>'),
  (1, 7, 'apple:album/never-gonna-give-you-up/1452434638?i=1452434833', '[phase 2] Never Gonna Give You Up (<b>Apple Music</b>) <u>requires premium subscription and browser extension</u>'),
  ...
  (1, 11, '', '[phase 4] <b>Plex</b> - <u>requires browser extension w/ background tab</u>'),
  (1, 12, '', '[phase 4] <b>Tidal</b> - <u>requires browser extension w/ background tab</u>'),
  (1, 13, '', '[phase 4] <b>Amazon</b> - <u>requires browser extension w/ background tab</u>'),
  (1, 14, 'drive:0B-klwLEjaXWcZHR5SmJJWEwtYnc/preview?resourcekey=0-D33DYWMxjVde0g1m7qsoZw', '[phase ??] Never Gonna Give You Up (<b>Google Drive</b>) - <u>on hold</u>'),
