...
DROP TABLE IF EXISTS fallbacks_history; -- depends on user
...
INSERT INTO oauth_link (user_id, provider, auth_id, auth_token)
VALUES
...
CREATE TABLE playlist_external_syn (
  id INT NOT NULL PRIMARY KEY,
...
VALUES
  (1, 0, 'youtube:dQw4w9WgXcQ', '[phase 1] Never Gonna Give You Up (<b>Youtube</b>)'),
  (1, 1, 'vimeo:681449396:6b2311bcf9', '[phase 1] Never Gonna Give You Up (<b>Vimeo</b>)'),
  (1, 2, 'soundcloud:1219405522', '[phase 1] Never Gonna Give You Up x Migos (<b>Soundcloud</b>)'),
  (1, 3, 'dropbox:audio:r1gdw6cssgdyb07nmv5i9/Chung-Antique-Sweater-Weather-01-Former-Farmer.mp3?rlkey=ifflu911fuh56rx3rp6xdc88m',
            '[phase 1] Chung Antique - Former Farmer (<b>Dropbox</b> share link)'),
  (1, 4, 'link:audio:https://files.ceenaija.com/wp-content/uploads/music/2023/07/Rick_Astley_-_Never_Gonna_Give_You_Up_CeeNaija.com_.mp3',
            '[phase 1] Never Gonna Give You Up - Live (<b>generic internet link</b>)'),
  (1, 5, 'spotify:4PTG3Z6ehGkBFwjybzWkR8', '[phase 1] Never Gonna Give You Up (<b>Spotify</b>) <u>requires premium subscription + browser extension</u>'),
  (1, 6, 'deezer:781592622', '[phase 2] Never Gonna Give You Up (<b>Deezer</b>) <u>requires premium subscription</u>'),
  ...
  (1, 8, 'mixcloud:ed-mash/focus-mix-vol-103-rick-astley-never-gonna-give-you-up', '[phase 3] Never Gonna Give You Up (<b>Mixcloud</b>)'),
  (1, 9, 'bandcamp:4248939073', '[phase 3] Never Gonna Give You Up - Remix (<b>Bandcamp</b>) - <u>requires browser extension;&nbsp;&nbsp;no paid tracks</u>'),
  (1, 10, 'archive:NeverGonnaGiveYouUp', '[phase 3] Never Gonna Give You Up (<b>Archive.org</b>)'),
  (1, 11, 'drive:0B-klwLEjaXWcZHR5SmJJWEwtYnc/preview?resourcekey=0-D33DYWMxjVde0g1m7qsoZw', '[phase ??] Never Gonna Give You Up (<b>Google Drive</b>) - <u>autoplay broken even with browser extension</u>'),
